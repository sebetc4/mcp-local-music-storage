...
fn tiny_png() -> Vec<u8> {
    vec![
        ...
        0x00, 0x00, 0x00, 0x0D, b'I', b'H', b'D', b'R', // width=1, height=1
        0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01,
        // bit depth=8, colour type=2 (RGB), compression=0, filter=0, interlace=0
        0x08, 0x02, 0x00, 0x00, 0x00, // IHDR CRC
        0x90, 0x77, 0x53, 0xDE, // IDAT: length=12
        0x00, 0x00, 0x00, 0x0C, b'I', b'D', b'A', b'T', // zlib-compressed single pixel
        0x08, 0x99, 0x63, 0xF8, 0xCF, 0xC0, 0x00, 0x00, 0x00, 0x03, 0x00, 0x01,
        // IDAT CRC
        0x5D, 0x76, 0xEA, 0x9E, // IEND: length=0
        0x00, 0x00, 0x00, 0x00, b'I', b'E', b'N', b'D', // IEND CRC
        0xAE, 0x42, 0x60, 0x82,
    ]
}
